...
class TestPostProcessors(unittest.TestCase):
    ...
    def test_cisco_iface_name_shorten(self):
        ...
        for line in input_list:
            ...
            with self.subTest(line=test):
                self.assertEqual(getattr(parse.post_pocessors, 'cisco_iface_name_shorten')(test), result)
    ...
    def test_cisco_route_type_expand(self):
        ...
        for line in input_list:
            test, result = line
            with self.subTest(line=test):
                self.assertEqual(getattr(parse.post_pocessors, 'cisco_route_type_expand')(test), result)
    ...
    def test_to_lowercase(self):
        ...
        for line in input_list:
            test, result = line
            with self.subTest(line=test):
                self.assertEqual(getattr(parse.post_pocessors, 'to_lowercase')(test), result)
    ...
    def test_digits_only(self):
        ...
        for line in input_list:
            test, result = line
            with self.subTest(line=test):
                self.assertEqual(getattr(parse.post_pocessors, 'digits_only')(test), result)
    ...
    def test_strip_domain(self):
        ...
        for line in input_list:
            test, result = line
            with self.subTest(line=test):
                self.assertEqual(getattr(parse.post_pocessors, 'strip_domain_from_hostname')(test), result)